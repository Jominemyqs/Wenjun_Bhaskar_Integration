...
% Create cumulative distribution from cell_pop_prop
cumulative_prob = cumsum(cell_pop_prop);

% Generate n random numbers between 0 and 1
rand_nums = rand(n, 1);

% Assign cell types based on random numbers and cumulative probabilities
cell_types = arrayfun(@(x) find(cumulative_prob >= x, 1, 'first'), rand_nums);
